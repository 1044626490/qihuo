...
class ShareButtons extends React.Component {
    ...
    render(){
        ...
        const templates = {
            ...
            weibo: `http://service.weibo.com/share/share.php?url=${url}&appkey=&title=${title}&pic=&ralateUid=&language=&searchPic=false`,
            wechat: `javascript:`,

            douban: `https://www.douban.com/share/service?href=${url}&name=${title}&text=${url}`,
        ...
        let html = _.map(sites, function (site) {
            if(site === "wechat"){
                let doc = <div className='wechat-qrcode'>
